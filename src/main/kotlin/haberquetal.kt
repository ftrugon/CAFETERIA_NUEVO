...
/**
 * Clase cafetera, la principal del programa
 * @param ubicacion es la sala donde esta la cafetera
 */
class Cafetera(private val ubicacion:String){

    /**
     * Entendi que capacidad el valor maximo seria 1000
     * No puse valores por defecto porque vi que las 3 cafeteras tenian ubicacion, capacidad y cantidad y se me paso
     */
    var capacidad = 0
        set(value) {
    ...
    /**
     * Constructor secundario que agrega capacidad
     * @param ubicacion es la sala donde esta la cafetera
     * @param capacidad la capacidad de la cafetera
     */
    ...
    /**
     * llena la capacidad de la cafetera
     */
    fun llenar(){
    ...
    /**
     * Sirve una taza, se le resta la capacidad de la taza y la taza se llena
     * @param taza es la taza a llenar
     */
    ...
    /**
     * agrega la cantidad de cafe que nosotros queramos
     * @param cafeaagregar es la cantidad de cafe que queremos agregar, por valor 200
     */
    fun agregarcafe(cafeaagregar:Int = 200){
        if ((cafeaagregar + cantidad) > capacidad){
            llenar()
        }else{
    ...
    /**
     * Informacion de la cafetera
     * @return La informacion de la cafetera en un string
     */
 ...
 * clase taza,
 */
class Taza(var color: color, var capacidad: Int){
    ...
    /**
     * Llena la taza con mayor cantidad
     * @param cap la nueva capacidad de taza
     */
    fun llenar(cap:Int){
        this.capacidad = cap
    }
    ...
    /**
     * Informacion de la taza
     * @return La informacion de la taza en un string
     */
    override fun toString(): String {
        return "TAZA: \n color : $color \n capacidad = $capacidad \n cantidad = $cantidad"
    }
...
fun main() {
    ...
    //val taza1 = Taza("blanco", Random.nextInt(1,50))
    //val taza2 = Taza("negro", Random.nextInt(1,50))
    //val taza3 = Taza("gris", Random.nextInt(1,50))
    //val taza4 = Taza("azul", Random.nextInt(1,50))
    //val taza5 = Taza("verde", Random.nextInt(1,50))
    //val taza6 = Taza("blanco", Random.nextInt(1,50))
    //val taza7 = Taza("blanco", Random.nextInt(1,50))
    //val taza8 = Taza("negro", Random.nextInt(1,50))
    //val taza9 = Taza("azul", Random.nextInt(1,50))
    //val taza10 = Taza("verde", Random.nextInt(1,50))
    //val taza11 = Taza("gris", Random.nextInt(1,50))
    //val taza12 = Taza("blanco", Random.nextInt(1,50))
    //val taza13 = Taza("azul", Random.nextInt(1,50))
    //val taza14 = Taza("negro", Random.nextInt(1,50))
    //val taza15 = Taza("verde", Random.nextInt(1,50))
    //val taza16 = Taza("blanco", Random.nextInt(1,50))
    //val taza17 = Taza("gris", Random.nextInt(1,50))
    //val taza18 = Taza("azul", Random.nextInt(1,50))
    //val taza19 = Taza("blanco", Random.nextInt(1,50))
    //val taza20 = Taza("verde", Random.nextInt(1,50))
//
    ...
    fun creaarlistatazas (num:Int= 20):List<Taza>{
